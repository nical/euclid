...
impl<T: Clone, U> TypedPoint2D<T, U> {
    pub fn get_x(&self) -> Length<T, U> { Length::new(self.x.clone()) }
    pub fn get_y(&self) -> Length<T, U> { Length::new(self.y.clone()) }
}
...
impl<U, T:Clone> TypedPoint2D<T, U> {
    /// Drop the units, preserving only the numeric value.
    pub fn to_untyped(&self) -> TypedPoint2D<T, Untyped> {
        TypedPoint2D::new(self.x.clone(), self.y.clone())
    }

    /// Tag a unitless value with units.
    pub fn from_untyped(p: &TypedPoint2D<T, Untyped>) -> TypedPoint2D<T, U> {
...
impl<U, T: NumCast + Clone> TypedPoint2D<T, U> {
...
impl<T: Clone, U> TypedPoint3D<T, U> {
    pub fn get_x(&self) -> Length<T, U> { Length::new(self.x.clone()) }
    pub fn get_y(&self) -> Length<T, U> { Length::new(self.y.clone()) }
    pub fn get_z(&self) -> Length<T, U> { Length::new(self.z.clone()) }
}
...
impl<T: Float, U> TypedPoint3D<T, U> {
    pub fn min(self, other: TypedPoint3D<T, U>) -> TypedPoint3D<T, U> {
         TypedPoint3D::new(self.x.min(other.x), self.y.min(other.y),
                           self.z.min(other.z))
    }
...
impl<T: Clone, U> TypedPoint4D<T, U> {
    ...
    pub fn get_y(&self) -> Length<T, U> { Length::new(self.y.clone()) }
    pub fn get_z(&self) -> Length<T, U> { Length::new(self.z.clone()) }
    pub fn get_w(&self) -> Length<T, U> { Length::new(self.w.clone()) }
}
